...
from left_hemisphere.pipelines.pipeline_classifier import EmailClassifierPipeline
from left_hemisphere.pipelines.pipeline_normal import NormalPipeline
from left_hemisphere.pipelines.pipeline_urgent import UrgentPipeline
