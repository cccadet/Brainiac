...
from right_hemisphere.pipelines.pipeline_classifier import EmailClassifierPipeline
from right_hemisphere.pipelines.pipeline_normal import NormalPipeline
from right_hemisphere.pipelines.pipeline_urgent import UrgentPipeline
